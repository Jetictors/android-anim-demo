 ...
 * Version        :  v-1.0.1
 */
class ObjectTranslateFragment : BasePropertyFragment(){

    override fun getAnimator(img : ImageView): Animator {

        val holder1 = PropertyValuesHolder.ofFloat("translationX", 0f, 400f)
        val holder2 = PropertyValuesHolder.ofFloat("translationY", 0f, 400f)
